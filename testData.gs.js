let firsts = ['Mohammed','Bob','Jamie',
              'Teri','Ryan','Alondra',
              'Marisol','Luzdivina','Perry',
              'George','Ray','Ryan']
let lasts = ['Smith','Gbagbo','Rodriguez',
            'Lopez','Lengsavat','Bui',
              'Ng','Wright','Perry',
              'Ryan','Hartman','Badajoz','Chu','Panagiatopolis']
let YOGs = [2029,2028]
let advisors = ['Hinkle','Orpen','Uyaguari','Lane','Murry','Pereyra','Bresnahan','Angelone']
...
function TestData () {
  ...
  this.populateSlots = () => {
    ...
    slotSheet.getRange(2,1,placementOptions.length,6).setValues(placementOptions);
  }
