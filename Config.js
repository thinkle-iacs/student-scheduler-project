...
function setupPlacementOptions () {
  ...
  sheet.getRange(2,PLACEMENT_FIELDS.length + 1,500,days.length).setDataValidation(SpreadsheetApp.newDataValidation().requireCheckbox());  
...
function makePlacementByDaySheet () {
  ...
  for (let i=0; i<days.length; i++) {
    ...
    sheet.getRange(2,i+1).setFormula(
